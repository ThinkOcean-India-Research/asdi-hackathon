...
class SpaceNetDataset(utils.Dataset):
    ...
    def load_dataset(self, dataset_dir, start=1, end=400):
        ...
        images_dir = os.path.join(dataset_dir, "masks/")
        annotations_dir = os.path.join(dataset_dir, "geojson/")
        ...
        for filename in os.listdir(images_dir)[start:end]:
            ...
            ann_path  = os.path.join(annotations_dir,"Geo_AOI_1_RIO_img"+str(image_id)+".geojson")            
    ...
    def load_image(self, image_id):
        ...
        specs in image_info.
        """
        image_dir = os.path.join(DATASET_DIR, "3band/3band_AOI_1_RIO_img"+str(image_id)+".tif")
        im = geoio.GeoImage(image_dir).get_data()
